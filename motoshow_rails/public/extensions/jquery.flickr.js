...
(function($) {
 ...
 console.log(href);
 return '<a href="#flickr-content"' + ' target="' + href + '"' +  ' >' + text + '</a>'
    }
  }
    ...
    return elements.each(function() {
      $.getJSON($.flickr.url(method, options), function(data) {
        ...
        elements.append($.flickr.thumbnail.process(photos))
                // event click picture 
                $('a[href="#flickr-content"]').click(function(e) {
                                              //alert('1');
                                                     var flickr_url =  e
                                                     console.log(flickr_url);
                                                     
                                                     $('#flickr-content-image').replaceWith('<div id="flickr-content-image"><img src="' + flickr_url.currentTarget.target + '"></div>');
